...
-- 2. Covering index for association table
...
ON loss_assoc_riskvalue_aggregationtag (aggregationtype, riskvalue, aggregationtag);;

-- 3. Index for calculation branch lookups
...
-- 4. Pattern-optimized index for aggregation tag filtering
...
-- 6. Asset-aggregationtag association index
...
-- 7. Materialized view name lookup index
